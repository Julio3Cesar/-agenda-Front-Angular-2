(function(mod) {
  if (typeof exports == "object" && typeof module == "object") { // CommonJS
    return mod(require("tern/lib/infer"), require("tern/lib/tern"), require("jshint/src/jshint").JSHINT, require, require("path"));
  }
  if (typeof define == "function" && define.amd) // AMD
    return define([ "tern/lib/infer", "tern/lib/tern", "jshint/src/jshint", "path" ], mod);
  mod(tern, tern, JSHINT, path);
})(function(infer, tern, JSHINT, require, path) {
  "use strict";
  ...
  JSHintConfig.prototype.getConfig = function(file) {
    if (this.defaultConfig) {
      this.config = cli.getConfig(file);
      if (this.config) {
        this.init();
        this.error = null;
        return this.config;
  ...
  function validate(server, query, file, messages) {
	...
	var config = jshintCfg.getConfig(path.join(server.projectDir, file.name)), globals = jshintCfg.globals;	
	if (jshintCfg.error) { 

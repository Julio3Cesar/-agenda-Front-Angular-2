...
var AotCompiler = (function () {
    ...
    AotCompiler.prototype.emitAllStubs = function (analyzeResult) {
        ...
        var sourceModules = files.map(function (file) { return _this._compileStubFile(file.srcUrl, file.directives, file.ngModules); });
    ...
    AotCompiler.prototype._createSummary = function (srcFileUrl, directives, pipes, ngModules, injectables, ngFactoryCtx) {
        ...
        return [
            new generated_file_1.GeneratedFile(srcFileUrl, util_2.summaryFileName(srcFileUrl), json),

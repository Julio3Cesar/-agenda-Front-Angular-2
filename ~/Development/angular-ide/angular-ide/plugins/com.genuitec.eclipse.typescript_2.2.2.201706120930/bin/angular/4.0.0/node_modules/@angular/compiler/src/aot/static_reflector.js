...
var StaticReflector = (function () {
    function StaticReflector(summaryResolver, symbolResolver, knownMetadataClasses, knownMetadataFunctions, errorRecorder) {
        ...
        try {
            ...
            if (e.message && e.message.startsWith("Could not resolve module @angular/core")) {
                throw new Error("VAL_ERR:Cannot find Angular 2 classes required to perform validation. " +
                    "Please ensure that your node_modules folder is up-to-date by running `npm install` command.");
            }
            else {
                throw e;
            }
    ...
    StaticReflector.prototype.simplify = function (context, value) {
        ...
        function simplifyInContext(context, value, depth) {
            ...
            try {
                ...
                var err = void 0;
                if (e.fileName) {
                    err = positionalError(message, e.fileName, e.line, e.column);
                }
                else {
                    err = util_1.syntaxError(message);
                }
                //copy stack over
                err.stack = e.stack;
                throw err;

    ...
    Object.defineProperty(TypeScriptServiceHost.prototype, "resolver", {
        ...
        get: function () {
            ...
            if (!result) {
                ...
                result = this._resolver = new compiler_1.CompileMetadataResolver(config, moduleResolver, this._directiveResolver, pipeResolver, new compiler_1.JitSummaryResolver(), elementSchemaRegistry, directiveNormalizer, new core_1.ɵConsole(), this._staticSymbolCache, this.reflector, function (error, type) { return _this.collectError(error, type && type.filePath); });
            }
            return result;
        },
        enumerable: true,
            ...
            if (fileMeta && fileMeta.directives) {
                ...
                uniqueDirectives_1.forEach(function (type) {
                    ...
                    function addExternalTemplate(url, declaration, checkAbsolute) {
                        ...
                        var fileName = urlResolver_1.resolve(this_.reflector.componentModuleUrl(directive.type.reference), url);

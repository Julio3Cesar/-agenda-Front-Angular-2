...
var Xliff = (function (_super) {
    ...
    Xliff.prototype.write = function (messages, locale) {
        ...
        messages.forEach(function (message) {
            ...
            (_a = transUnit.children).push.apply(_a, [new xml.CR(8), new xml.Tag(_SOURCE_TAG, {}, visitor.serialize(message.nodes)),
                new xml.CR(8), new xml.Tag(_TARGET_TAG)].concat(contextTags));

...
var LanguageServiceHost = (function () {
    function LanguageServiceHost(projectName, compilationSettings, endpoint, sourceRoots, tsConfigFile) {
        this.projectName = projectName;
        this.compilationSettings = compilationSettings;
        this.endpoint = endpoint;
        this.sourceRoots = sourceRoots;
        this.tsConfigFile = tsConfigFile;
        this.tsConfigDir = path.dirname(this.tsConfigFile);
    ...
    LanguageServiceHost.prototype.prepareRefactoringChanges = function (source, destination, preChanges) {
        return this.refactoringManager.prepareRefactoringChanges(source, destination, preChanges);
    };
    ...
    LanguageServiceHost.prototype.setupSettings = function () {
        ...
        this.compilationSettings.configFilePath = path.join("eclipse:" + this.projectName, this.tsConfigFile);
    };
